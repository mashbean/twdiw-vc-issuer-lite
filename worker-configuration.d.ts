/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: aab198ebba793bb5a2fde415e09be1c3)
// Runtime types generated with workerd@1.20260907.1 2026-09-03 nodejs_compat
interface __BaseEnv_Env {
	OFFICIAL_TRUST_REGISTRY_URL: "https://frontend.wallet.gov.tw/api/did";
	ISSUER_ORIGIN: "";
	IDENTITY: DurableObjectNamespace<import("./src/index").IssuerIdentity>;
	ISSUANCES: DurableObjectNamespace<import("./src/index").IssuanceSession>;
	SESSIONS: DurableObjectNamespace<import("./src/index").PresentationSession>;
	MONITOR: DurableObjectNamespace<import("./src/index").MonitorState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IssuerIdentity" | "IssuanceSession" | "PresentationSession" | "MonitorState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OFFICIAL_TRUST_REGISTRY_URL" | "ISSUER_ORIGIN">> {}
}
